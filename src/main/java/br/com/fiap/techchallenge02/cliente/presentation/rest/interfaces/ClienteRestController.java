package br.com.fiap.techchallenge02.cliente.presentation.rest.interfaces;
...
import br.com.fiap.techchallenge02.core.utils.validators.cpf.Cpf;
...
public interface ClienteRestController {
    ...
    br.com.fiap.techchallenge02.cliente.common.domain.dto.response.ClienteResponseDto buscarClientePorCpf(@Parameter(description = "CPF válido do cliente", example = "52932609017", required = true)  @Valid @Cpf String cpf);
