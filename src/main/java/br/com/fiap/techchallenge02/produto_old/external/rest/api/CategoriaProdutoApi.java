package br.com.fiap.techchallenge02.produto_old.external.rest.api;
...
public interface CategoriaProdutoApi {
    ...
    ResponseEntity<CategoriaProdutoResponseDTO> buscarCategoriaProduto(@Parameter(description = "ID da categoria de produto", example = "1", required = true) String id);
